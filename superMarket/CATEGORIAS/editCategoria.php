...
$dataCate = new Categorias();

$categoriaId = $_GET['categoriaId'];
$dataCate -> setCategoriaid($categoriaId);


$record1 = $dataCate -> selectOneCate();
...
if(isset($_POST['editar'])){
    ...
    $dataCate -> setNombre($_POST['nombre']);
    $dataCate -> setDescripcion($_POST['descripcion']);


    $dataCate->updateCate();
    echo "<script>alert('actualizado exitosamente');document.location='categorias.php'</script>";
      ...
      <form class="col d-flex flex-wrap" action=""  method="post">
              ...
              <div class="mb-1 col-12">
                ...
                <input 
                  ...
                  name="descripcion"
                  class="form-control"  
                  value="<?php echo $valCate['descripcion']; ?>"
