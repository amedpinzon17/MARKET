...
$allProve = $dataProve -> selectProveeAll();
  ...
  <div class="contenedor">
    ...
    <div class="parte-izquierda">
      ...
      <div class="perfil">
        ...
        <img src="../images/png-transparent-online-shopping-drawing-electricity-supplier-transaction-model-celebrities-text-photography-removebg-preview.png" alt="" class="imagenPerfil">
        <h3>CampusLands</h3>
      </div>
      <div class="menus">
       ...
       <a href="../CATEGORIAS/categorias.php" style="display: flex;gap:2px;">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-users" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" fill="none" stroke-linecap="round" stroke-linejoin="round">
         ...
         <a href="../EMPLEADOS/emplados.php" style="display: flex;gap:1px;">
          <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-users" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
            <path d="M9 7m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0" />
            <path d="M3 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2" />
         ...
         <a href="../PROVEDORES/provedores.php" style="display: flex;gap:1px;">
          ...
          <h3 style="margin: 0px;font-weight: 800;">Provedores</h3>
        </a>
        ...
        <table class="table table-custom ">
          ...
          <tbody class="" id="tabla">
            ...
            <!-- Llenado DInamico desde la Base de Datos -->
             ...
             <?php foreach ($allProve as $key => $val) { ?>
              <tr>
                <td> <?php echo $val['provedorId']; ?> </td>
                <td> <?php echo $val['nombre']; ?> </td>
                <td> <?php echo $val['telefono']; ?> </td>
                <td> <?php echo $val['ciudad']; ?> </td>

                 <td>
                    <a class="btn btn-danger" href="borrarPrevee.php?provedorId=<?= $val['provedorId']?>&req=delete">Borrar</a>
                    <a class="btn btn-warning" href="editProvee.php?provedorId=<?= $val['provedorId']?>">Editar</a>
                </td>
              </tr>
          ...
          <div class="modal-body" style="background-color: rgb(231, 253, 246);">
            <form class="col d-flex flex-wrap" action = "../CONFIG/registro.php" method="post">
              ...
              <div class=" col-12 m-2">
                <input type="submit" class="btn btn-primary" value="guardarProve" name="guardarProve"/>
              </div>
            </form>  
         </div>       
        </div>
