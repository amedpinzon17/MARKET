...
<body>
  <div class="contenedor">
    ...
    <div class="parte-izquierda">
      ...
      <div class="perfil">
        <h3 style="margin-bottom: 2rem;">CSuper Market.</h3>
        <img src="../images/png-transparent-brick-lane-market-animation-tokyo-food-service-innovation-removebg-preview.png" alt="" class="imagenPerfil">
        <h3>CampusLands</h3>
      </div>
      <div class="menus">
