...
$dataEmplea = new Empleados();

$allEmplea = $dataEmplea -> selectEmpleaAll();
  ...
  <div class="contenedor">
    ...
    <div class="parte-izquierda">
      ...
      <div class="perfil">
        ...
        <img src="../images/png-transparent-social-media-personal-branding-marketing-company-employer-branding-business-sales-customer-removebg-preview.png" alt="" class="imagenPerfil">
        <h3>CampusLands</h3>
      </div>
      <div class="menus">
      ...
      <div class="menuTabla contenedor2">
        <table class="table table-custom ">
          ...
          <tbody class="" id="tabla">
            ...
            <?php foreach ($allEmplea as $key => $val) {   ?>
              <tr>
                <td> <?php echo $val['empleadosId']; ?> </td>
                ...
                <td> <?php echo $val['imagen']; ?> </td>
                 ...
                 <td>
                    <a class="btn btn-danger" href="borarEmpleados.php?empleadosId=<?= $val['empleadosId']?>&req=delete">Borrar</a>
                    <a class="btn btn-warning" href="editEmpleados.php?empleadosId=<?= $val['empleadosId']?>">Editar</a>
                </td>
              </tr>
          ...
          <div class="modal-body" style="background-color: rgb(231, 253, 246);">
            <form class="col d-flex flex-wrap" action="../CONFIG/registro.php" method="post">
              ...
              <div class=" col-12 m-2">
                <input type="submit" class="btn btn-primary" value="guardarEmpleados" name="guardarEmpleados"/>
              </div>
            </form>  
         </div>       
        </div>
