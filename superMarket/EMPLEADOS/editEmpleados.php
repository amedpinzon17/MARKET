...
$empleadosId = $_GET['empleadosId'];
$data->setEmpleadosId($empleadosId); 

$record = $data->selectEmpleaOne(); 
...
if(isset($_POST['editar2'])){
    ...
    $data -> updateEmplae(); 
    echo "<script>alert('actualizado exitosamente');document.location='empleados.php'</script>";
}
