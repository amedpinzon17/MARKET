...
$dataClient = new Clientes();

$idCliernte = $_GET['idcliente'];
$dataClient -> setIdCliente($idCliernte);

$record2 = $dataClient -> selectClient();
...
if(isset($_POST['editar2'])){
    ...
    $dataClient -> setCompañia($_POST['compañia']);

    $dataClient -> updateClient();
    echo "<script>alert('actualizado exitosamente');document.location='cliente.php'</script>";
    ...
    <div class="parte-media">
      ...
      <form class="col d-flex flex-wrap" action=""  method="post">
              ...
              <div class=" col-12 m-2">
                <input type="submit" class="btn btn-primary" value="UPDATE" name="editar2"/>
              </div>
            </form>  
