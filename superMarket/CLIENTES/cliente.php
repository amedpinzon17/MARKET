...
$dataClien = new Clientes();

$allClien = $dataClien -> selectClienAll();
      ...
      <div class="menuTabla contenedor2">
        <table class="table table-custom ">
          ...
          <tbody class="" id="tabla">
            ...
            <?php foreach($allClien as $key => $val)  {      ?>
              ...
              <tr>
                ...
                <td>
                  <a class="btn btn-danger" href="borrarCliente.php?idcliente=<?= $val['idcliente']?>&req=delete">Borrar</a>
                  <a class="btn btn-warning" href="editCliente.php?idcliente=<?= $val['idcliente']?>">Editar</a>
                </td>
              </tr>
          ...
          <div class="modal-body" style="background-color: rgb(231, 253, 246);">
            <form class="col d-flex flex-wrap" action="../CONFIG/registro.php" method="post">
              ...
              <div class=" col-12 m-2">
                <input type="submit" class="btn btn-primary" value="guardarCliente" name="guardarCliente"/>
              </div>
            </form>  
         </div>       
        </div>
